---
name: html-report
description: Create a static HTML response or visual report. Use when asked to respond in HTML, generate an HTML report, or present findings with diagrams. Invoke with /skill:html-report.
---
